...
async def serve_manifest():
    # Return a valid web-app manifest directly.  Keeping this independent of a
    # physical file prevents the SPA fallback from returning index.html when
    # manifest.webmanifest is missing from a deployment.
    manifest = {
        "name": "Kasi Sports News",
        "short_name": "Kasi Sports",
        "description": "Live scores, sports news, predictions and sports intelligence.",
        "start_url": "/",
        "scope": "/",
        "display": "standalone",
