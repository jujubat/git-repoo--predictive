...
AUTH_DB = Path(os.getenv("AUTH_DB", str(BASE_DIR / "kasiscore_users.db")))
...
# ---------------------------------------------------------------------------
PUSH_DB = Path(os.getenv("PUSH_DB", str(BASE_DIR / "kasiscore_push.db")))
...
LOTTERY_DB = Path(os.getenv("LOTTERY_DB", str(BASE_DIR / "kasiscore_lottery.db")))
LOTTERY_GAMES = {
