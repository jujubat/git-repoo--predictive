...
@app.get("/matches/{fixture_id}/stats")
async def canonical_match_stats_page(fixture_id:str):
    return RedirectResponse(url=f"/match/football/{fixture_id}",status_code=307)

@app.get("/teams/{team_id}")
async def canonical_team_page(team_id:str):
    return RedirectResponse(url=f"/team/{team_id}",status_code=307)

@app.get("/players/{player_id}")
async def canonical_player_page(player_id:str):
    return RedirectResponse(url=f"/player/{player_id}",status_code=307)
