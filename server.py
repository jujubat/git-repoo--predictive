...
def _is_generic_news_image(url: str) -> bool:
    u=(url or "").lower()
    return (not u) or any(x in u for x in ("news.google","google.com/images","gstatic","googleusercontent","google_news","favicon","branding","logo_google","googlelogo","googleg/"))
