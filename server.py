...
# Kasi Sports News v202 editorial retention UX
app = FastAPI(
...
async def live(
    ...
    + the SAME Kasi Sports News prediction engine.
    """
...
async def _render_seo_document(path: str) -> str:
    ...
    # v202: SEO metadata/schema stay in <head>; the old visible SSR article is removed.
    _SSR_CACHE[key]=html
    return html
