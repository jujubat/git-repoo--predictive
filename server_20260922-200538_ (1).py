...
if not AUTH_SECRET:
    # Persist the secret to disk so it survives server restarts.
    # Without this, every restart generates a new secret which
    # immediately invalidates all existing browser tokens and causes instant logout.
    ...
    if not AUTH_SECRET:
        ...
        try:
            ...
            pass  # if we cannot write, server still starts
def _auth_db():
